...
export default function ButtonCircleArrow({btnProps, text, action, iconPos}: Props){
  ...
  const continueShoppingButtonCls = `w-min whitespace-nowrap hover:text-emerald-500 duration-200 mb-4 ${iconPos === "right" ? "mr-10" : "ml-10"}`;
  ...
  return(
    ...
    sx={{":hover > div": {...buttonIconPos, opacity: 1}}}>
      <div className={`absolute top-[-5%] ${iconPos === "right" ? "right-10" : "left-10"} 
